 ...
 return (
    <section key={item._id} className="text-gray-600 body-font w-full  overflow-hidden">
            <div className="container px-5 py-24 mx-auto flex">
                <div className="lg:w-4/5 mx-auto flex flex-wrap flex-reverse  border-black">
                ...
                <div className="lg:w-1/2 w-full lg:pr-10 lg:py-6 mb-6 lg:mb-0 bg-white  p-5 ">

                  {/* <h2 className="text-sm title-font text-black tracking-widest">{item.category.name}</h2> */}
                  <h1 className="text-gray-900 text-3xl title-font font-bold mb-4">{item.title}</h1>
                  <div className="flex mb-4">
                    <p className="flex-grow text-black   py-2 text-lg px-1">{item.description}</p>
